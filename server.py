...
mycursor.execute("CREATE TABLE IF NOT EXISTS Users(id VARCHAR(255) NOT NULL PRIMARY KEY, nome VARCHAR(255) NOT NULL, idade VARCHAR(11) NOT NULL, email VARCHAR(255) NOT NULL, sexo ENUM('Masculino','Feminino') NOT NULL )")
...
mycursor.execute(user.sqlUser, user.inserirUser)
